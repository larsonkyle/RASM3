...
driver: test1.o test2.o String1.o String2.o
	ld -o driver String1/test1.o String2/test2.o String1/String1.o String2/String2.o -lc objfiles/String_length.o objfiles/putch.o objfiles/int64asc.o objfiles/putstring.o objfiles/ascint64.o objfiles/getstring.o 
